...
Сделать 02.12.23:
    1. вместо кастомного декоратора времени использовать встроенные в либе тайм 
    2. функции корстадис и простадис почти идентичны - сделать из них одну и добавить к ним експорт датную часть из бейсиков и вольюма 
    3. вынести нонсерийную функциональность в отдельную функцию
    4. вызывать это все дело в старте по пакетам - должно быть аккуратнее
    перед тем как это все делать соханить рабочую версию ))
'''
